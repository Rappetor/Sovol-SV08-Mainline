...
12. After the restart, you can *un*comment the `[adxl345]` and `[resonance_tester]` parts in your printer.cfg to have those functional again; you can also initiate the webcam through the Mainsail settings (Settings > Webcams > Add Webcam).
